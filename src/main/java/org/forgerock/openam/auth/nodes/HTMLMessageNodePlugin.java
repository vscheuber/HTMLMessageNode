...
public class HTMLMessageNodePlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(HTMLMessageNodePlugin.currentVersion, 
				Collections.singletonList(HTMLMessageNode.class));
	}
	...
	public void upgrade(String fromVersion) throws PluginException {
		pluginTools.upgradeAuthNode(HTMLMessageNode.class);
	}
	...
	public String getPluginVersion() {
		return HTMLMessageNodePlugin.currentVersion;
	}
}
